<?php
session_start();
require_once($_SERVER["DOCUMENT_ROOT"] . "/controllers/Log-In.php");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="fields">
                <form @submit="logIn">
                    <div class="field">
                        ...
                        <input autocomplete="email" type="text" placeholder="Enter your Username" name="username" v-model="username" required>
                    </div>

                    <div class="field">
                        <label for="password">Password</label>
                        <input autocomplete="email" type="password" placeholder="Enter your Password" name="password" v-model="password" required>
                    </div>
